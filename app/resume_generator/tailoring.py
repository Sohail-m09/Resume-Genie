...
8. Rewrite project descriptions only to improve clarity,
   relevance, and presentation of existing evidence.
9. Preserve all factual metrics exactly as supported by the
   original resume.
10. Never turn a semantic match into a claim of direct experience.
...
13. Return only the structured TailoredResume object.
"""
